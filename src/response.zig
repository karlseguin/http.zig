...
pub const Response = struct {
    ...
    fn prepareHeader(self: *Response) ![]const u8 {
        ...
        switch (self.status) {
            100 => @memcpy(buf[0..15], "HTTP/1.1 100 \r\n"),
            101 => @memcpy(buf[0..15], "HTTP/1.1 101 \r\n"),
            102 => @memcpy(buf[0..15], "HTTP/1.1 102 \r\n"),
            103 => @memcpy(buf[0..15], "HTTP/1.1 103 \r\n"),
            200 => @memcpy(buf[0..15], "HTTP/1.1 200 \r\n"),
            201 => @memcpy(buf[0..15], "HTTP/1.1 201 \r\n"),
            202 => @memcpy(buf[0..15], "HTTP/1.1 202 \r\n"),
            203 => @memcpy(buf[0..15], "HTTP/1.1 203 \r\n"),
            204 => @memcpy(buf[0..15], "HTTP/1.1 204 \r\n"),
            205 => @memcpy(buf[0..15], "HTTP/1.1 205 \r\n"),
            206 => @memcpy(buf[0..15], "HTTP/1.1 206 \r\n"),
            207 => @memcpy(buf[0..15], "HTTP/1.1 207 \r\n"),
            208 => @memcpy(buf[0..15], "HTTP/1.1 208 \r\n"),
            226 => @memcpy(buf[0..15], "HTTP/1.1 226 \r\n"),
            300 => @memcpy(buf[0..15], "HTTP/1.1 300 \r\n"),
            301 => @memcpy(buf[0..15], "HTTP/1.1 301 \r\n"),
            302 => @memcpy(buf[0..15], "HTTP/1.1 302 \r\n"),
            303 => @memcpy(buf[0..15], "HTTP/1.1 303 \r\n"),
            304 => @memcpy(buf[0..15], "HTTP/1.1 304 \r\n"),
            305 => @memcpy(buf[0..15], "HTTP/1.1 305 \r\n"),
            306 => @memcpy(buf[0..15], "HTTP/1.1 306 \r\n"),
            307 => @memcpy(buf[0..15], "HTTP/1.1 307 \r\n"),
            308 => @memcpy(buf[0..15], "HTTP/1.1 308 \r\n"),
            400 => @memcpy(buf[0..15], "HTTP/1.1 400 \r\n"),
            401 => @memcpy(buf[0..15], "HTTP/1.1 401 \r\n"),
            402 => @memcpy(buf[0..15], "HTTP/1.1 402 \r\n"),
            403 => @memcpy(buf[0..15], "HTTP/1.1 403 \r\n"),
            404 => @memcpy(buf[0..15], "HTTP/1.1 404 \r\n"),
            405 => @memcpy(buf[0..15], "HTTP/1.1 405 \r\n"),
            406 => @memcpy(buf[0..15], "HTTP/1.1 406 \r\n"),
            407 => @memcpy(buf[0..15], "HTTP/1.1 407 \r\n"),
            408 => @memcpy(buf[0..15], "HTTP/1.1 408 \r\n"),
            409 => @memcpy(buf[0..15], "HTTP/1.1 409 \r\n"),
            410 => @memcpy(buf[0..15], "HTTP/1.1 410 \r\n"),
            411 => @memcpy(buf[0..15], "HTTP/1.1 411 \r\n"),
            412 => @memcpy(buf[0..15], "HTTP/1.1 412 \r\n"),
            413 => @memcpy(buf[0..15], "HTTP/1.1 413 \r\n"),
            414 => @memcpy(buf[0..15], "HTTP/1.1 414 \r\n"),
            415 => @memcpy(buf[0..15], "HTTP/1.1 415 \r\n"),
            416 => @memcpy(buf[0..15], "HTTP/1.1 416 \r\n"),
            417 => @memcpy(buf[0..15], "HTTP/1.1 417 \r\n"),
            418 => @memcpy(buf[0..15], "HTTP/1.1 418 \r\n"),
            421 => @memcpy(buf[0..15], "HTTP/1.1 421 \r\n"),
            422 => @memcpy(buf[0..15], "HTTP/1.1 422 \r\n"),
            423 => @memcpy(buf[0..15], "HTTP/1.1 423 \r\n"),
            424 => @memcpy(buf[0..15], "HTTP/1.1 424 \r\n"),
            425 => @memcpy(buf[0..15], "HTTP/1.1 425 \r\n"),
            426 => @memcpy(buf[0..15], "HTTP/1.1 426 \r\n"),
            428 => @memcpy(buf[0..15], "HTTP/1.1 428 \r\n"),
            429 => @memcpy(buf[0..15], "HTTP/1.1 429 \r\n"),
            431 => @memcpy(buf[0..15], "HTTP/1.1 431 \r\n"),
            451 => @memcpy(buf[0..15], "HTTP/1.1 451 \r\n"),
            500 => @memcpy(buf[0..15], "HTTP/1.1 500 \r\n"),
            501 => @memcpy(buf[0..15], "HTTP/1.1 501 \r\n"),
            502 => @memcpy(buf[0..15], "HTTP/1.1 502 \r\n"),
            503 => @memcpy(buf[0..15], "HTTP/1.1 503 \r\n"),
            504 => @memcpy(buf[0..15], "HTTP/1.1 504 \r\n"),
            505 => @memcpy(buf[0..15], "HTTP/1.1 505 \r\n"),
            506 => @memcpy(buf[0..15], "HTTP/1.1 506 \r\n"),
            507 => @memcpy(buf[0..15], "HTTP/1.1 507 \r\n"),
            508 => @memcpy(buf[0..15], "HTTP/1.1 508 \r\n"),
            510 => @memcpy(buf[0..15], "HTTP/1.1 510 \r\n"),
            511 => @memcpy(buf[0..15], "HTTP/1.1 511 \r\n"),
            else => |s| {
